<template>
  <div class="flex flex-col">
    <div class="flex flex-row px-2 py-2 mb-2 border-b border-gray-lighter dark:border-gray-darker">
      ...
      <div class="w-32 text-xs text-right uppercase md:mx-2 fles-none text-gray-dark dark:text-gray-default" />
    </div>

    <div v-for="file in files" :key="file.id" class="flex flex-row items-center px-2 py-3 mb-2 transition-all duration-200 ease-in-out rounded hover:bg-gray-lightest dark:hover:bg-gray-darker">
