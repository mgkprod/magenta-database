        ...
        >
            ...
            <div class="flex-none w-10 mx-2">
                <vue-load-image class="rounded-t aspect-w-1 aspect-h-1">
                    ...
                    <div class="flex items-center justify-center opacity-50" :style="{ 'background-color': song.image_dominant_color }" slot="preloader"><i class="text-xs text-black dark:text-white fas fa-spin fa-spinner"></i></div>
                </vue-load-image>
            </div>
