export default {
    ...
    input: ({ props }) => ({
        class: [
            ...
            // States
            'outline-none focus:ring-indigo-500 dark:focus:ring-indigo-400',
    ...
    inputicon: {
        class: ['sm:text-sm', 'absolute top-[50%] -mt-2', 'text-neutral-600 dark:text-neutral-200', 'right-[.75rem]']
    },
    dropdownbutton: {
        root: {
            class: [
    ...
    weekheader: {
        class: ['leading-6 text-sm font-normal', 'text-neutral-600 dark:text-white/70', 'opacity-40 cursor-default', 'mb-2']
    },
    weeknumber: {
        class: ['text-neutral-600 dark:text-white/70 font-normal', 'opacity-40 cursor-default']
    },
    weekday: {
        class: [
            // Colors
            'text-neutral-500 dark:text-white/60 font-normal'
        ]
    },
    day: {
        class: [
    ...
    weeklabelcontainer: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-neutral-600 dark:text-white/70 bg-transparent': !context.selected && !context.disabled,
                'text-indigo-500  dark:text-indigo-400': context.selected && !context.disabled
            },

            // States
            'focus:outline-none focus:outline-offset-0 focus:ring focus:ring-indigo-400/50 dark:focus:ring-indigo-300/50',
            {
                'hover:bg-neutral-100 dark:hover:bg-neutral-800/80': !context.disabled
            },
            {
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-neutral-0 bg-neutral-900 dark:text-neutral-900 dark:bg-neutral-0': context.date.today && !context.selected && !context.disabled,
                'text-neutral-600 dark:text-white/70 bg-transparent': !context.selected && !context.disabled && !context.date.today,
                'text-indigo-500 dark:text-indigo-400': context.selected && !context.disabled && !context.date.today,
                'text-indigo-200 dark:text-indigo-600 bg-neutral-900 dark:bg-neutral-0': context.selected && !context.disabled && context.date.today
            },

            // States
            'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-400',
            {
                'hover:bg-neutral-100 dark:hover:bg-neutral-600/80': !context.disabled,
                'hover:bg-neutral-700 dark:hover:bg-neutral-200': !context.disabled && context.date.today
            },
    ...
    month: ({ context }) => ({
        class: [
            ...
            // States
            'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-400',
            'hover:bg-neutral-100 dark:hover:bg-neutral-600/80',
