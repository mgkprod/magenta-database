  ...
  <div>
    ...
    <div class="p-4 md:p-8">
      ...
      <p v-if="route().current('songs.index', { filter: 'published-lost' })" class="mb-8 text-sm">
        <i class="mr-2 opacity-50 fas fa-info-circle"></i> Les tracks officiels qui ne sont pas dans à un album ou
        présent dans un event
      </p>
      <p v-if="route().current('songs.index', { filter: 'really-unreleased' })" class="mb-8 text-sm">
        <i class="mr-2 opacity-50 fas fa-info-circle"></i> Les tracks qui n'ont pas eu de release et qu'on a entendu
        qu'une fois
      </p>
      ...
      <p v-if="route().current('songs.index', { filter: 'deleted' })" class="mb-8 text-sm">
        <i class="mr-2 opacity-50 fas fa-info-circle"></i> Les tracks qui ont été publiés un jour et qui sont
        aujourd'hui retirés des plateformes
      </p>
