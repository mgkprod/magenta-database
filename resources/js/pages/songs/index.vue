    ...
    <div class="p-4 md:p-8">
      <div class="fade-overflow-x">
        <div class="flex flex-row items-start justify-start mb-4 -mx-2 overflow-x-auto font-semibold" scroll-region>
          ...
          <div class="flex-none w-16 h-1" />
        </div>
      </div>

      <p class="mb-8 text-sm"><i class="mr-2 opacity-50 fas fa-info-circle" /> {{ $page.props.filters[$page.props.current_filter].description }}</p>
      ...
      <div class="flex items-center justify-center">
        ...
        <inertia-link v-if="songs.next_page_url" preserve-scroll :href="songs.next_page_url" class="transition duration-200 ease-in-out text-gray-dark dark:text-gray-default hover:text-gray-darker dark:hover:text-gray-lightest">
