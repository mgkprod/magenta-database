...
export default {
    ...
    methods: {
        ...
        start_upload() {
            ...
            this.upload.file = this.$refs.file.$el.querySelector(
                "input"
            ).files[0];
            ...
            this.upload.reader.onloadend = e => {
                ...
                axios
                    ...
                    .then(response => {
                        ...
                        this.upload.progress = Math.floor(
                            (size_done / this.upload.file.size) * 100
                        );
        ...
        complete() {
            this.$inertia.post(this.route("songs.files.store", this.song), {
                handle: this.handle,
                name: this.form.name,
