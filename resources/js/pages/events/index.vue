<template>
  <div>
    <inertia-head>
      <title>Events</title>
      <meta head-key="description" name="description" content="Tous les tracks regroupés par évènements" />
    </inertia-head>
